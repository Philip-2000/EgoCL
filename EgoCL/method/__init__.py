...
from .Video import VideoMethod, VideoEncoderFactory  #although they still can be accessed via "EgoCL.method.Video.<class_name>", but at least, such a way greatly increases the difficulty of access.
