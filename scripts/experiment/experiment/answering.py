...
if __name__ == "__main__":
    ...
    args = parse()
    E = AnswerExperiment(config_path=args.config_path, method_yaml_name=args.method, experience_yaml_name=args.experience, q_list=args.q_list.split(",") if args.q_list != "all" else "all")
    E()